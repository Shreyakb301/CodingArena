    ...
    step(
        ...
        languageVariants = listOf(
            WorkoutCodeVariant(
                ...
                "left = 0\nright = len(s) - 1\nwhile left < right:\n    # ???\nreturn True",
                choices = listOf(
                    choice("while left < right and not s[left].isalnum():\n    left += 1\nwhile left < right and not s[right].isalnum():\n    right -= 1\nif left < right:\n    if s[left].lower() != s[right].lower():\n        return False\n    left += 1\n    right -= 1", true, "Guarding every skip loop with left < right prevents either pointer from running past the other on a string with no alphanumeric characters at all, avoiding an out-of-bounds read.", code = "while left < right and not s[left].isalnum():\n    left += 1\nwhile left < right and not s[right].isalnum():\n    right -= 1\nif left < right:\n    if s[left].lower() != s[right].lower():\n        return False\n    left += 1\n    right -= 1"),
                    choice("while not s[left].isalnum():\n    left += 1\nwhile not s[right].isalnum():\n    right -= 1\nif s[left].lower() != s[right].lower():\n    return False\nleft += 1\nright -= 1", false, "Without the left < right guard, a string with no alphanumeric characters at all lets one of the skip loops run straight past the other pointer and off the end of the string.", code = "while not s[left].isalnum():\n    left += 1\nwhile not s[right].isalnum():\n    right -= 1\nif s[left].lower() != s[right].lower():\n    return False\nleft += 1\nright -= 1"),
                    choice("if not s[left].isalnum():\n    left += 1\n    return True\nif not s[right].isalnum():\n    right -= 1\n    return True", false, "Returning True the moment a non-alphanumeric character is seen abandons the check entirely instead of skipping past it and continuing to compare the rest of the string.", code = "if not s[left].isalnum():\n    left += 1\n    return True\nif not s[right].isalnum():\n    right -= 1\n    return True"),
                ),
            ),
            WorkoutCodeVariant(
                JAVA,
                ...
                choices = listOf(
                    choice("while (left < right && !Character.isLetterOrDigit(s.charAt(left))) left++;\nwhile (left < right && !Character.isLetterOrDigit(s.charAt(right))) right--;\nif (left < right) { if (Character.toLowerCase(s.charAt(left)) != Character.toLowerCase(s.charAt(right))) return false; left++; right--; }", true, "Guarding every skip loop with left < right prevents either pointer from running past the other on a string with no alphanumeric characters at all, avoiding an out-of-bounds read.", code = "while (left < right && !Character.isLetterOrDigit(s.charAt(left))) left++;\nwhile (left < right && !Character.isLetterOrDigit(s.charAt(right))) right--;\nif (left < right) { if (Character.toLowerCase(s.charAt(left)) != Character.toLowerCase(s.charAt(right))) return false; left++; right--; }"),
                    choice("while (!Character.isLetterOrDigit(s.charAt(left))) left++;\nwhile (!Character.isLetterOrDigit(s.charAt(right))) right--;\nif (Character.toLowerCase(s.charAt(left)) != Character.toLowerCase(s.charAt(right))) return false;\nleft++;\nright--;", false, "Without the left < right guard, a string with no alphanumeric characters at all lets one of the skip loops run straight past the other pointer and off the end of the string.", code = "while (!Character.isLetterOrDigit(s.charAt(left))) left++;\nwhile (!Character.isLetterOrDigit(s.charAt(right))) right--;\nif (Character.toLowerCase(s.charAt(left)) != Character.toLowerCase(s.charAt(right))) return false;\nleft++;\nright--;"),
                    choice("if (!Character.isLetterOrDigit(s.charAt(left))) { left++; return true; }\nif (!Character.isLetterOrDigit(s.charAt(right))) { right--; return true; }", false, "Returning true the moment a non-alphanumeric character is seen abandons the check entirely instead of skipping past it and continuing to compare the rest of the string.", code = "if (!Character.isLetterOrDigit(s.charAt(left))) { left++; return true; }\nif (!Character.isLetterOrDigit(s.charAt(right))) { right--; return true; }"),
                ),
            ),
            WorkoutCodeVariant(
                JAVASCRIPT,
                ...
                choices = listOf(
                    choice("while (left < right && !/[a-z0-9]/i.test(s[left])) left++;\nwhile (left < right && !/[a-z0-9]/i.test(s[right])) right--;\nif (left < right) { if (s[left].toLowerCase() !== s[right].toLowerCase()) return false; left++; right--; }", true, "Guarding every skip loop with left < right prevents either pointer from running past the other on a string with no alphanumeric characters at all, avoiding an out-of-bounds read.", code = "while (left < right && !/[a-z0-9]/i.test(s[left])) left++;\nwhile (left < right && !/[a-z0-9]/i.test(s[right])) right--;\nif (left < right) { if (s[left].toLowerCase() !== s[right].toLowerCase()) return false; left++; right--; }"),
                    choice("while (!/[a-z0-9]/i.test(s[left])) left++;\nwhile (!/[a-z0-9]/i.test(s[right])) right--;\nif (s[left].toLowerCase() !== s[right].toLowerCase()) return false;\nleft++;\nright--;", false, "Without the left < right guard, a string with no alphanumeric characters at all lets one of the skip loops run straight past the other pointer and off the end of the string.", code = "while (!/[a-z0-9]/i.test(s[left])) left++;\nwhile (!/[a-z0-9]/i.test(s[right])) right--;\nif (s[left].toLowerCase() !== s[right].toLowerCase()) return false;\nleft++;\nright--;"),
                    choice("if (!/[a-z0-9]/i.test(s[left])) { left++; return true; }\nif (!/[a-z0-9]/i.test(s[right])) { right--; return true; }", false, "Returning true the moment a non-alphanumeric character is seen abandons the check entirely instead of skipping past it and continuing to compare the rest of the string.", code = "if (!/[a-z0-9]/i.test(s[left])) { left++; return true; }\nif (!/[a-z0-9]/i.test(s[right])) { right--; return true; }"),
                ),
            ),
            WorkoutCodeVariant(
                CPP,
                "int left = 0;\nint right = s.size() - 1;\nwhile (left < right) {\n    // ???\n}\nreturn true;",
                choices = listOf(
                    choice("while (left < right && !isalnum(s[left])) left++;\nwhile (left < right && !isalnum(s[right])) right--;\nif (left < right) { if (tolower(s[left]) != tolower(s[right])) return false; left++; right--; }", true, "Guarding every skip loop with left < right prevents either pointer from running past the other on a string with no alphanumeric characters at all, avoiding an out-of-bounds read.", code = "while (left < right && !isalnum(s[left])) left++;\nwhile (left < right && !isalnum(s[right])) right--;\nif (left < right) { if (tolower(s[left]) != tolower(s[right])) return false; left++; right--; }"),
                    choice("while (!isalnum(s[left])) left++;\nwhile (!isalnum(s[right])) right--;\nif (tolower(s[left]) != tolower(s[right])) return false;\nleft++;\nright--;", false, "Without the left < right guard, a string with no alphanumeric characters at all lets one of the skip loops run straight past the other pointer and off the end of the string.", code = "while (!isalnum(s[left])) left++;\nwhile (!isalnum(s[right])) right--;\nif (tolower(s[left]) != tolower(s[right])) return false;\nleft++;\nright--;"),
                    choice("if (!isalnum(s[left])) { left++; return true; }\nif (!isalnum(s[right])) { right--; return true; }", false, "Returning true the moment a non-alphanumeric character is seen abandons the check entirely instead of skipping past it and continuing to compare the rest of the string.", code = "if (!isalnum(s[left])) { left++; return true; }\nif (!isalnum(s[right])) { right--; return true; }"),
                ),
            ),
            WorkoutCodeVariant(
                GO,
                "left := 0\nright := len(s) - 1\nfor left < right {\n    // ???\n}\nreturn true",
                choices = listOf(
                    choice("for left < right && !isAlnum(s[left]) {\n    left++\n}\nfor left < right && !isAlnum(s[right]) {\n    right--\n}\nif left < right {\n    if unicode.ToLower(rune(s[left])) != unicode.ToLower(rune(s[right])) {\n        return false\n    }\n    left++\n    right--\n}", true, "Guarding every skip loop with left < right prevents either pointer from running past the other on a string with no alphanumeric characters at all, avoiding an out-of-bounds read.", code = "for left < right && !isAlnum(s[left]) {\n    left++\n}\nfor left < right && !isAlnum(s[right]) {\n    right--\n}\nif left < right {\n    if unicode.ToLower(rune(s[left])) != unicode.ToLower(rune(s[right])) {\n        return false\n    }\n    left++\n    right--\n}"),
                    choice("for !isAlnum(s[left]) {\n    left++\n}\nfor !isAlnum(s[right]) {\n    right--\n}\nif unicode.ToLower(rune(s[left])) != unicode.ToLower(rune(s[right])) {\n    return false\n}\nleft++\nright--", false, "Without the left < right guard, a string with no alphanumeric characters at all lets one of the skip loops run straight past the other pointer and off the end of the string.", code = "for !isAlnum(s[left]) {\n    left++\n}\nfor !isAlnum(s[right]) {\n    right--\n}\nif unicode.ToLower(rune(s[left])) != unicode.ToLower(rune(s[right])) {\n    return false\n}\nleft++\nright--"),
                    choice("if !isAlnum(s[left]) {\n    left++\n    return true\n}\nif !isAlnum(s[right]) {\n    right--\n    return true\n}", false, "Returning true the moment a non-alphanumeric character is seen abandons the check entirely instead of skipping past it and continuing to compare the rest of the string.", code = "if !isAlnum(s[left]) {\n    left++\n    return true\n}\nif !isAlnum(s[right]) {\n    right--\n    return true\n}"),
                ),
            ),
            WorkoutCodeVariant(
                SWIFT,
                ...
                choices = listOf(
                    choice("while left < right && !(chars[left].isLetter || chars[left].isNumber) { left += 1 }\nwhile left < right && !(chars[right].isLetter || chars[right].isNumber) { right -= 1 }\nif left < right {\n    if Character(chars[left].lowercased()) != Character(chars[right].lowercased()) { return false }\n    left += 1\n    right -= 1\n}", true, "Guarding every skip loop with left < right prevents either pointer from running past the other on a string with no alphanumeric characters at all, avoiding an out-of-bounds read.", code = "while left < right && !(chars[left].isLetter || chars[left].isNumber) { left += 1 }\nwhile left < right && !(chars[right].isLetter || chars[right].isNumber) { right -= 1 }\nif left < right {\n    if Character(chars[left].lowercased()) != Character(chars[right].lowercased()) { return false }\n    left += 1\n    right -= 1\n}"),
                    choice("while !(chars[left].isLetter || chars[left].isNumber) { left += 1 }\nwhile !(chars[right].isLetter || chars[right].isNumber) { right -= 1 }\nif Character(chars[left].lowercased()) != Character(chars[right].lowercased()) { return false }\nleft += 1\nright -= 1", false, "Without the left < right guard, a string with no alphanumeric characters at all lets one of the skip loops run straight past the other pointer and off the end of the string.", code = "while !(chars[left].isLetter || chars[left].isNumber) { left += 1 }\nwhile !(chars[right].isLetter || chars[right].isNumber) { right -= 1 }\nif Character(chars[left].lowercased()) != Character(chars[right].lowercased()) { return false }\nleft += 1\nright -= 1"),
                    choice("if !(chars[left].isLetter || chars[left].isNumber) { left += 1; return true }\nif !(chars[right].isLetter || chars[right].isNumber) { right -= 1; return true }", false, "Returning true the moment a non-alphanumeric character is seen abandons the check entirely instead of skipping past it and continuing to compare the rest of the string.", code = "if !(chars[left].isLetter || chars[left].isNumber) { left += 1; return true }\nif !(chars[right].isLetter || chars[right].isNumber) { right -= 1; return true }"),
                ),
            ),
        ),
    ),
